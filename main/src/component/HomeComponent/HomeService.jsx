...
const HomeService = () => {
    return (
        <Flex direction={'column'} gap='50px' px="3%" mt="20px">
            ...
            {
                data.map((el,ind)=>(
                    <Flex key={ind} direction={'column'} boxShadow={"rgba(99, 99, 99, 0.2) 0px 2px 8px 0px"} borderBottomRadius={'20px'} bg="red.50" >{/**_hover={{ transform: "scale(1.05)", transition: "all 0.3s ease" }} */}
