...
const HomePage = () => {
  ...
  const textColor = text==='dark'?'gray.300':'blackAlpha.900'
    ...
    <Box pt="70px">
      ...
      <Box w="100%">
        <Box position={'relative'} w="100%" h='100vh' bgImg={home} bgRepeat={'no-repeat'} bgSize={'cover'} bgPosition={'center'} display={{ base: 'none', md: 'none', lg: 'block' }}>
         ...
         <Heading fontSize={'50px'}>Shopping With Vardhaman Electronics</Heading>
          <Heading>New Experience</Heading>
          <Heading fontSize={'40px'} letterSpacing={'5px'}>GREAT PRICE</Heading>
          <Text fontSize='20px'>Save now 20% off on Vardhaman Store</Text>
      ...
      <Flex p={"3%"} gap="20px" direction={{base:'column',md:'row'}} mt="30px" >
        <Box pos={'relative'} w={{base:'100%',md:'41.5%'}} _hover={{ transform: "scale(1.05)", transition: "all 0.3s ease" }}>
        ...
        <Box pos={'relative'} w={{base:'100%',md:"59%"}}  _hover={{ transform: "scale(1.05)", transition: "all 0.3s ease" }}>
          ...
          <Flex pos={'absolute'} right={'10px'} top={'20px'} direction={'column'} gap="10px" color={'blackAlpha.900'}>
            ...
            <Text>Starting from: Rs.2000.00</Text>
